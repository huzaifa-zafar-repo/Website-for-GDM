  ...
  return (
    <section id="hero" className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75 flex items-baseline">
  <span className="text-blue-100 mr-8">DEZIGN</span>
  <span className="text-blue-75">MART</span>
</h1>
      ...
      {/* <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75 flex items-baseline">
  <span className="text-blue-100 mr-6">DESIGN</span>
  <span className="text-blue-75">MART</span>
</h1> */}
    </section>
  );
